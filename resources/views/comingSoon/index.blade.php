		...
		<div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
			...
			<div class="p-t-50 p-b-60">
				<p class="m1-txt1 p-b-36">
					Our website is <span class="m1-txt2">Coming Soon</span>, follow us to stay updated!
				</p>

				<p class="s2-txt3 p-t-18">
					Brought to you by your favourite amplifier in business development, <a href="https://upwritsolutions.com" style="font-family: 'Caveat', cursive; font-weight: 500; font-size: 1.3em;">UpWrit Solutions.</a>
				</p>
			</div>
