  ...
  <aside class="main-sidebar sidebar-dark-primary sideMenu elevation-4 border-right border-dark">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2 bg-transparent">
        ...
        <!------ Sub-Menu ----->
          <li class="nav-item">
            <router-link to="" class="nav-link text-light d-flex justify-content-start">
...
<!-- Main Footer -->
  <footer class="main-footer sideMenu text-secondary pt-2 pb-2 border-top border-secondary text-sm">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021-2022 <a href="#">UpWrit Solutions</a>.</strong> All rights reserved.
  </footer>
<!-- ./Main Footer -->
